				...
				<tbody>
					...
					<tr>
						<form action="index.php?uc=gererGenres" method="post">
							...
							<td>
								<?php afficherListe($tbMembres, 'lstMembre', 1, '', -2); ?>
							</td>
							<td>
								0
							</td>
					...
					?>
						<tr>
							...
							<form action="index.php?uc=gererGenres" method="post">
								...
								<td>
									<?php echo $genre->nomSpecialiste; ?>
								</td>
								<td>
									<?php echo $genre->nbJeux; ?>
								</td>
								<td>
							...
							?><input type="text" id="txtLibGenre" name="txtLibGenre" size="24" required minlength="4" maxlength="24" value="<?php echo $genre->libelle; ?>" />
								...
								<td>
									<?php afficherListe($tbMembres, 'lstMembre', 1, $genre->idSpecialiste, -1); ?>
								</td>
								<td>
									<?php echo $genre->nbJeux; ?>
								</td>
